...
(function() {
	...
	L.extend(L.Routing, require('./L.Routing.Mapzen'));
...
},{"./L.Routing.ErrorControl":5,"./L.Routing.Itinerary":8,"./L.Routing.Line":10,"./L.Routing.Mapzen":13,"./L.Routing.Plan":14}],5:[function(require,module,exports){
(function() {
	'use strict';
...
(function() {
	...
	L.Routing.Line = L.LayerGroup.extend({
		...
		initialize: function(route, options) {
			...
			this._route = route;
	                var is_walk = (route.costing == 'pedestrian') ? true : false
...
(function() {
  ...
  L.Routing.Mapzen = L.Class.extend({
    ...
    route: function(waypoints, callback, context, options) {
      ...
      //this happens if costing mode switches
    ...
    _getSubRoutes: function(legs) {
      ...
      for (var i = 0; i < legs.length; i++) {
        ...
        for(var j = 0; j < legs[i].maneuvers.length; j++){
          ...
          if(res.transit_info) subRoute.push({operator_onestop_id: res.transit_info.operator_onestop_id})
...
},{"corslite":1,"polyline":2}],14:[function(require,module,exports){
(function (global){
(function() {
	'use strict';
